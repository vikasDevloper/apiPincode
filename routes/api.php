...
$api->version('v1', function($api){
    ...
    $api->group(['middleware' => ['throttle:60,1', \Illuminate\Routing\Middleware\SubstituteBindings::class], 'namespace' => 'App\Http\Controllers'], function($api) {
        ...
        $api->get('storePincode', 'Api\PingController@index');
        ...
        $api->group(['middleware' => ['auth:api'], ], function ($api) {
          ...
          $api->get('/storePincode', 'Api\Assets\UploadFileController@storePincode');

            $api->get('/index-paging', 'Api\Assets\UploadFileController@indexPaging');
